...
async function loadUserInfo() {
  try {
    ...
    const response = await fetch(
      `https://team2-ws.bettercalldave.io/api/getUser/`,
      {
        method: "GET",
        headers: {
...
async function getRandomMonster() {
  ...
  try {
    const response = await fetch(
      `https://team2-ws.bettercalldave.io/api/getRandomMonster/`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function handleEndCombat(starterPV, monsterPV, nbPotion) {
  ...
  try {
    ...
    await fetch("https://team2-ws.bettercalldave.io/api/EndCombat", {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        "Authorization": token  
